...
type EchoServiceClient interface {
	...
	Baz(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error)
}
...
func (c *echoServiceClient) Foo(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	out := new(EchoResponse)
	err := c.cc.Invoke(ctx, "/echo.EchoService/Foo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *echoServiceClient) Baz(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	out := new(EchoResponse)
	err := c.cc.Invoke(ctx, "/echo.EchoService/Baz", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EchoServiceServer interface {
	...
	Baz(context.Context, *EchoRequest) (*EchoResponse, error)
...
func (UnimplementedEchoServiceServer) Baz(context.Context, *EchoRequest) (*EchoResponse, error) {
...
func _EchoService_Foo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EchoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EchoServiceServer).Foo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/echo.EchoService/Foo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EchoServiceServer).Foo(ctx, req.(*EchoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EchoService_Baz_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EchoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EchoServiceServer).Baz(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/echo.EchoService/Baz",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EchoServiceServer).Baz(ctx, req.(*EchoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EchoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Baz",
			Handler:    _EchoService_Baz_Handler,
		},
	},
